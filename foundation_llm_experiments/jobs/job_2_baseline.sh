...
#SBATCH --output=/projects/%u/mono-s2s/foundation_llm_experiments/logs/job_2_baseline_%j.out
#SBATCH --error=/projects/%u/mono-s2s/foundation_llm_experiments/logs/job_2_baseline_%j.err
