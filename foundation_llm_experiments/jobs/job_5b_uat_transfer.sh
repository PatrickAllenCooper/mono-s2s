...
sys.exit(0 if check_completion_flag('stage_5b_uat_transfer') else 1)
"; then
    echo "Stage 5b already complete for seed ${EXPERIMENT_SEED} model ${FOUNDATION_MODEL_NAME}. Nothing to do."
    exit 0
fi
