...
#SBATCH --output=/projects/%u/mono-s2s/foundation_llm_experiments/logs/job_0_setup_%j.out
#SBATCH --error=/projects/%u/mono-s2s/foundation_llm_experiments/logs/job_0_setup_%j.err
