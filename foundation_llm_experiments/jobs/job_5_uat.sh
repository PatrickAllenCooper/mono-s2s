...
sys.exit(0 if check_completion_flag('stage_5_uat') else 1)
"; then
    echo "Stage 5 already complete for seed ${EXPERIMENT_SEED} model ${FOUNDATION_MODEL_NAME}. Nothing to do."
    exit 0
fi
