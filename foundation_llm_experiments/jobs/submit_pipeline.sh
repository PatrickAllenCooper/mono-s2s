#!/bin/bash
# Submit a Pythia stage chain. Override partition for H200 / RTX Pro.
#
...
MODEL="${PYTHIA_MODEL_NAME:-EleutherAI/pythia-1.4b}"
...
EXPORT="ALL,EXPERIMENT_SEED=${SEED},PYTHIA_MODEL_NAME=${MODEL},MONOTONIC_VARIANT=${VARIANT},CONDA_ENV=${CONDA_ENV},SCRATCH=${SCRATCH:-/scratch/alpine/$USER},PROJECT=${PROJECT:-/projects/$USER}"
...
echo "Submitting Pythia chain seed=$SEED model=$MODEL variant=$VARIANT partition=$PARTITION"
