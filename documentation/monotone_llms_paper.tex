...
\begin{table}[t]
\caption{Attack consistency across evaluation seeds. HotFlip results using seed 42 trained checkpoints, evaluated with three different random seeds for attack sampling. All three seeds show identical robustness patterns.}
...
\begin{tabular}{lccc}
\toprule
Seed & Baseline Success & Monotonic Success & Reduction \\
\midrule
42   & 63\% & 19\% & 69.8\% \\
1337 & 63\% & 19\% & 69.8\% \\
2024 & 63\% & 19\% & 69.8\% \\
\midrule
\textbf{Consistency} & \textbf{0\% var} & \textbf{0\% var} & \textbf{Stable} \\
\bottomrule
\end{tabular}
\end{small}
\vskip -0.1in
