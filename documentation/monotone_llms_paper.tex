...
\textcolor{blue}{All experiments use fixed random seeds (Python, NumPy, and PyTorch set to 42) with deterministic algorithms enabled. Training is conducted on a single NVIDIA A100 GPU with 40GB memory using PyTorch 2.0.1 and Transformers 4.30.2.}
